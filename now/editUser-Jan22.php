					...
					<form method="post" action="" class="newUserWell editUserForm" id="viewUser">
						...
						<div class="input-group newUserField">
							<span class="input-group-addon" >Address</span>
								<div class="form-group errorBox">
									<input type="text" class="form-control" id="user_address" placeholder="123 Sesame st" aria-describedby="basic-addon1">
								</div>
						</div>
						<div id="addressErrorMsg">
						...
						<button class="btn btn-primary submitText" id="createUserButton" type="button" onclick="checkInput();" name="" 
						> SAVE CHANGES </button>
					</form>
